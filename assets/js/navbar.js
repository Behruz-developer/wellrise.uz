document.addEventListener("DOMContentLoaded", function () {
    ...
    function smoothScroll(event) {
      ...
      if (window.innerWidth < 1200) {
        ...
        closeAllDropdowns(); // Mobil versiyada barcha dropdown menyulari yopiladi
      }
    }
    ...
    // Foydalanuvchi dropdown menyudan tashqari joyga bosganda barcha dropdown menyulari yopiladi
